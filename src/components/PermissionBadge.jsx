...
const MAP = {
  captain:    { label: 'Captain',   cls: 'bg-emerald-500/20 text-emerald-500 border-emerald-500/50' },
  member:     { label: 'Member',    cls: 'bg-orange-500/20 text-orange-500 border-orange-500/50' },
