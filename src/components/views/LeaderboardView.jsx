                    ...
                    {leaderboardView === 'current' ? (
                      ...
                      <div className="flex items-center gap-1.5 flex-wrap">
                        {team.weekHistory?.length > 0 ? team.weekHistory.map((result, wi) => {
                          const cls = result === 'W' ? 'bg-green-500/30 border-green-500 text-green-400' : result === 'L' ? 'bg-red-500/30 border-red-500 text-red-400' : result === 'P' ? 'bg-blue-500/20 border-blue-500/50 text-sky-400' : 'bg-gray-100 border-gray-300 text-slate-400';
                        ...
                        <div className="flex flex-wrap gap-2">
                          {team.memberList.map((m, mi) => (
                            <div key={mi} className="flex items-center gap-1.5 bg-gray-100 rounded-full px-2.5 py-1">
                              <div className="w-5 h-5 rounded-full bg-blue-500/20 border border-blue-200 flex items-center justify-center text-sky-400 font-bold text-xs flex-shrink-0">
