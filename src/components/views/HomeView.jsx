  ...
  return (
    <>
      <section className="relative pt-28 pb-16 px-4 sm:px-6 overflow-hidden">
        {/* Background radials */}
        <div className="absolute inset-0 bg-gradient-to-b from-teal-900/12 via-transparent to-transparent pointer-events-none" />
        <div className="absolute top-16 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-teal-500/5 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-32 right-0 w-72 h-72 bg-teal-600/4 rounded-full blur-3xl pointer-events-none" />
        <div className="absolute top-32 left-0 w-72 h-72 bg-teal-600/4 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-black mb-5 bg-gradient-to-b from-slate-900 via-teal-700 to-teal-600 bg-clip-text text-transparent leading-[1.08]">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center mb-4">
            {isLoggedIn ? (
              <button
                ...
                className="bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-500 hover:to-teal-600 text-white px-8 py-3.5 rounded-xl font-bold text-base transition-all duration-200 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg shadow-teal-500/25 cursor-pointer"
              >
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-2.5 mb-12">
            <button
              ...
              className="border border-gray-300 hover:border-teal-200 bg-white hover:bg-teal-500/5 text-slate-500 hover:text-teal-700 px-5 py-2 rounded-lg text-sm font-medium transition-all duration-200 flex items-center justify-center gap-2 cursor-pointer"
            >
          ...
          <div className="grid grid-cols-3 gap-3 max-w-md mx-auto">
            {[
              ...
              <div key={l} className="bg-white border border-gray-200 hover:border-teal-500/25 rounded-xl p-4 transition-colors group">
                <div className="text-teal-600/60 mb-1.5 flex justify-center group-hover:text-teal-700 transition-colors">{icon}</div>
                <div className="text-xl font-black text-teal-600 leading-tight" style={{ fontFamily: "'Barlow Condensed', sans-serif" }}>{v}</div>
