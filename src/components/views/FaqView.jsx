    ...
    <div className="max-w-3xl mx-auto">
      ...
      <div className="mb-10">
        <div className="inline-flex items-center gap-2 bg-emerald-500/10 border border-emerald-500/25 rounded-full px-4 py-1.5 mb-4">
          ...
          <span className="text-emerald-500 text-xs font-bold tracking-widest uppercase">Help Centre</span>
        </div>
      ...
      <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl p-6 text-center mt-8">
        ...
        <button
          ...
          className="bg-gradient-to-r from-orange-500 to-red-500 text-white px-6 py-2.5 rounded-xl font-bold text-sm transition-all hover:scale-105"
        >
          View Full Rules
        </button>
      </div>
