    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-6">
      <div className="max-w-md w-full bg-white/[0.04] border border-white/[0.08] rounded-xl p-8 text-center">
        ...
        <div className="flex gap-3 justify-center">
          <button
            onClick={onReset}
            className="px-4 py-2 rounded-lg bg-emerald-500/20 border border-emerald-500/40 text-emerald-500 text-sm font-medium hover:bg-emerald-500/30 transition-colors"
          >
            Try again
          </button>
          <button
